...
// Github
export const ENV_GIT_PRIVATE_KEY_GITHUB = process.env.REACT_APP_GITHUB_PRIVATE_KEY
...
export const ENV_GIT_TOKEN_LIST_FILENAME = process.env.REACT_APP_TOKEN_LIST_FILENAME
...
export const MAIN_TOKEN = new Token(ChainId.MAINNET, STAKING_TOKEN_CONTRACT, 6, 'VERO', 'VERO FARM')
...
export const FEE_NETWORK_LIMIT = 0.00025
